    ...
    <div className="dot-grid min-h-[calc(100vh-4rem)] text-[#e4e1ed]">
      <section className="relative mx-auto flex w-full max-w-7xl flex-col gap-10 px-6 pb-14 pt-36 lg:flex-row lg:items-center">
        ...
        <div className="z-10 flex-1 space-y-6">
          <h1 className="text-5xl font-bold tracking-tight">
            Field Sales,
            <span className="block text-[#c0c1ff]">Simplified.</span>
          </h1>
          <p className="max-w-xl text-base text-[#c7c4d7]">
        ...
        <div className="relative z-10 flex-1">
          ...
          <div className="glass-card absolute -bottom-8 -right-4 hidden w-28 rounded-xl p-1 sm:block">
      ...
      <section className="mx-auto -mt-2 w-full max-w-7xl px-6">
        <div className="glass-card grid grid-cols-2 gap-6 rounded-xl px-6 py-6 text-center md:grid-cols-4">
          {stats.map((item) => (
            <div key={item.label}>
              <p className="text-2xl font-semibold text-[#c0c1ff]">{item.value}</p>
      ...
      <section className="mx-auto w-full max-w-7xl px-6 py-16">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6">
          {[{ logo: metroMilanLogo, label: 'Metro Milan' }, { logo: franscentLogo, label: 'Franscent Fragrance' }].map((brand) => (
            <div key={brand.label} className="glass-card flex items-center gap-3 rounded-xl px-5 py-3">
